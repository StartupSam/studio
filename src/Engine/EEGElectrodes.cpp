...
void EEGElectrodes::Init()
{
	...
	// Others
	// 64 numeric electrodes (fake layout, good placement for first 8)
	mElectrodes.Add( Electrode("1",  90.0, 20.000) );
	mElectrodes.Add( Electrode("2",  90.0, 40.000) );
	mElectrodes.Add( Electrode("3",  90.0, 60.000) );
	mElectrodes.Add( Electrode("4",  90.0, 80.000) );
	mElectrodes.Add( Electrode("5", -90.0, 80.000) );
	mElectrodes.Add( Electrode("6", -90.0, 60.000) );
	mElectrodes.Add( Electrode("7", -90.0, 40.000) );
	mElectrodes.Add( Electrode("8", -90.0, 20.000) );
	mElectrodes.Add( Electrode("9",  180.000, 0.000) );
	mElectrodes.Add( Electrode("10", 180.000, 0.000) );
	mElectrodes.Add( Electrode("11", 180.000, 0.000) );
	mElectrodes.Add( Electrode("12", 180.000, 0.000) );
	mElectrodes.Add( Electrode("13", 180.000, 0.000) );
	mElectrodes.Add( Electrode("14", 180.000, 0.000) );
	mElectrodes.Add( Electrode("15", 180.000, 0.000) );
	mElectrodes.Add( Electrode("16", 180.000, 0.000) );
	mElectrodes.Add( Electrode("17", 180.000, 0.000) );
	mElectrodes.Add( Electrode("18", 180.000, 0.000) );
	mElectrodes.Add( Electrode("19", 180.000, 0.000) );
	mElectrodes.Add( Electrode("20", 180.000, 0.000) );
	mElectrodes.Add( Electrode("21", 180.000, 0.000) );
	mElectrodes.Add( Electrode("22", 180.000, 0.000) );
	mElectrodes.Add( Electrode("23", 180.000, 0.000) );
	mElectrodes.Add( Electrode("24", 180.000, 0.000) );
	mElectrodes.Add( Electrode("25", 180.000, 0.000) );
	mElectrodes.Add( Electrode("26", 180.000, 0.000) );
	mElectrodes.Add( Electrode("27", 180.000, 0.000) );
	mElectrodes.Add( Electrode("28", 180.000, 0.000) );
	mElectrodes.Add( Electrode("29", 180.000, 0.000) );
	mElectrodes.Add( Electrode("30", 180.000, 0.000) );
	mElectrodes.Add( Electrode("31", 180.000, 0.000) );
	mElectrodes.Add( Electrode("32", 180.000, 0.000) );
	mElectrodes.Add( Electrode("33", 180.000, 0.000) );
	mElectrodes.Add( Electrode("34", 180.000, 0.000) );
	mElectrodes.Add( Electrode("35", 180.000, 0.000) );
	mElectrodes.Add( Electrode("36", 180.000, 0.000) );
	mElectrodes.Add( Electrode("37", 180.000, 0.000) );
	mElectrodes.Add( Electrode("38", 180.000, 0.000) );
	mElectrodes.Add( Electrode("39", 180.000, 0.000) );
	mElectrodes.Add( Electrode("40", 180.000, 0.000) );
	mElectrodes.Add( Electrode("41", 180.000, 0.000) );
	mElectrodes.Add( Electrode("42", 180.000, 0.000) );
	mElectrodes.Add( Electrode("43", 180.000, 0.000) );
	mElectrodes.Add( Electrode("44", 180.000, 0.000) );
	mElectrodes.Add( Electrode("45", 180.000, 0.000) );
	mElectrodes.Add( Electrode("46", 180.000, 0.000) );
	mElectrodes.Add( Electrode("47", 180.000, 0.000) );
	mElectrodes.Add( Electrode("48", 180.000, 0.000) );
	mElectrodes.Add( Electrode("49", 180.000, 0.000) );
	mElectrodes.Add( Electrode("50", 180.000, 0.000) );
	mElectrodes.Add( Electrode("51", 180.000, 0.000) );
	mElectrodes.Add( Electrode("52", 180.000, 0.000) );
	mElectrodes.Add( Electrode("53", 180.000, 0.000) );
	mElectrodes.Add( Electrode("54", 180.000, 0.000) );
	mElectrodes.Add( Electrode("55", 180.000, 0.000) );
	mElectrodes.Add( Electrode("56", 180.000, 0.000) );
	mElectrodes.Add( Electrode("57", 180.000, 0.000) );
	mElectrodes.Add( Electrode("58", 180.000, 0.000) );
	mElectrodes.Add( Electrode("59", 180.000, 0.000) );
	mElectrodes.Add( Electrode("60", 180.000, 0.000) );
	mElectrodes.Add( Electrode("61", 180.000, 0.000) );
	mElectrodes.Add( Electrode("62", 180.000, 0.000) );
	mElectrodes.Add( Electrode("63", 180.000, 0.000) );
	mElectrodes.Add( Electrode("64", 180.000, 0.000) );
